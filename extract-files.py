...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/libarcsoft_hta.so', 'vendor/lib64/libarcsoft_superportrait.so', 'vendor/lib64/libsnpe_dsp_domains_v2.so', 'vendor/lib64/libsnpe_adsp.so', 'vendor/lib64/libsnpe_dsp_domains.so', 'vendor/lib64/libVDFusionBlurlessAPI_v2.so', 'odm/lib64/libaiboost_hexagon.so', 'vendor/lib64/libarcsoft_hdrplus_hvx_stub.so', 'vendor/lib64/libarcsoft_high_dynamic_range_v4.so', 'vendor/lib64/libarcsoft_mfsr_frt.so', 'vendor/lib64/libarcsoft_super_night_raw.so', 'vendor/lib64/libarcsoft_dualcam_refocus_preview.so'): blob_fixup()
    ...
    'system_ext/lib64/libcsextimpl.so': blob_fixup()
        ...
        .replace_needed('android.hardware.camera.device-V1-ndk', 'android.hardware.camera.device-V3-ndk')
        .replace_needed('android.hardware.camera.provider-V1-ndk', 'android.hardware.camera.provider-V3-ndk')
